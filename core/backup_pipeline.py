...
from core.backup_targets.form_path_manager import (
    FormPathManager,
)
...
class BackupPipeline:
    ...
    def execute(self):
        ...
        try:
            ...
            destination_path = (
                settings_result["data"]["destination_path"]
            )

            delete_temp_files = (
                settings_result["data"]["delete_temp_files"]
            )
            ...
            session_path = (
                session_result["data"]["session_path"]
            )

            session_name = (
                session_result["data"]["session_name"]
            )
            ...
            if destination_path:
                ...
                destination_result = (
                    destination_manager.copy_backup(
            ...
            if delete_temp_files:
                ...
                cleanup_manager.delete_directory(
                    session_path
                )
